...
**Shoping Cart' App** "An e-commerce shopping cart application that allows users to browse products, add items to their cart, view and manage their cart contents, and proceed to checkout for a seamless shopping experience."<a href="https://reactjs.org/">React.js</a>
...
- **[Reusable Components]**
- **[Client side routing]**
- **[Backend build with Node.js routing, Express, and MongoDb]**
- **[Use remote data from DATABASE]**
...
```sh
  cd my-folder
  git clone https://github.com/KAYEMBAJONATHAN/Fullstuck-pro.git (For the backend)
```

```sh
  cd my-folder
  git clone https://github.com/KAYEMBAJONATHAN/Fullstuck-pro-frontend.git (For the Frontend)
```
